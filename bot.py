...
async def start(bot, message):
    await message.reply(
        ...
        "**If you send post which had Pdisk Links, texts & images... Than I'll convert & replace all pdisk links with your doodstream links Message me @mrpunisher52 For more help-**")
...
async def remove_username(new_List):
    for i in new_List:
        if('https://bit.ly/3m4gabB' in i or 'https://bit.ly/pdisk_tuts' in i):
            new_List.remove(i)
    return new_List
